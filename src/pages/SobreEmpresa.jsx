  ...
  return (
    <MainLayout>
      <div className="relative w-full">
        ...
        />
        <div className="absolute top-1/4 left-4 sm:left-8 lg:left-24 text-white">
      ...
      <div className="flex flex-col lg:flex-row min-h-[70vh]">
        ...
        <div className="w-full lg:w-1/2 bg-red-600 flex flex-col justify-center px-6 sm:px-8 py-12 text-white">
