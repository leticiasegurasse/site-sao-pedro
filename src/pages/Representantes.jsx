                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`transform transition-transform duration-300 ${
                        isSelected ? 'rotate-180 text-red-600' : 'text-gray-500'
                      }`}>
                        ▼
                      </span>
                    </div>
                    ...
                    {isSelected && (
                      <div className="mt-3 pt-3 border-t border-red-200 space-y-4 animate-in fade-in duration-300">
...
const BrazilMapInteractiveDesktop = ({ selectedState, onStateClick }) => {
  ...
  const getStateClasses = (stateCode) => {
    return `stroke-white stroke-1 transition-all duration-300 cursor-pointer ${
